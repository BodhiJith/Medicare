        ...
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
          ...
          <div>
            <div className='lg:w-[570px]'>
              ...
              <p className='text__para'>Medicare medical Center is a leading hospital dedicated to providing exceptional healthcare services. With a focus on patient-centered care, they offer a wide range of medical treatments, state-of-the-art facilities, and a compassionate team of experts. Their mission is to improve the well-being of patients, from routine check-ups to complex conditions, ensuring safety and satisfaction throughout the healthcare journey?
              </p>
  ...
  <section>
    <div className='container'>
      <div className='xl:w-[470px] mx-auto'>
        ...
        <p className='text__para text-center'>
          World class care for everypne. Our health system offers unmatched,
          expert health care. From the lab to the clinic.
        </p>
      </div>
      <ServiceList/>
  ...
  <section>
    ...
    <div className='xl:w-[670px]'>
      <h2 className='heading'>
        Get Virtual Treatments <br/> Anytime.
      </h2>
      ...
      <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
        ...
        md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pg-[26px] rounded-[10px]'>
          <div className='flex items-center justify-between'>
            ...
            bg-yellowColor rounded py-1 px-[6px] lg:pv-3 lg:px-[9px]'>
